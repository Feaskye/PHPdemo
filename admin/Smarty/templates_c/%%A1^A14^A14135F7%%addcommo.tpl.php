...
<form id="addcommo" name="addcomm" enctype="multipart/form-data" method="post" action="addcommo_chk.php"  onsubmit="return chkcommo(addcommo)">
    ...
    <tr>
    	...
    	<td height="25" class="right">
    		<input id="m_price" name="m_price" type="text" class="shorttxt" onkeyup="cvp(addcommo)">&nbsp;元
            <font color="#FF0000">*</font>        </td>
    </tr>
	<tr>
        <td height="25" class="left">打折率：</td>
        <td height="25" class="right">
        	<input id="fold" name="fold" type="text" value="9" class="shorttxt" onkeyup="cvp(addcommo)">&nbsp;折
            <font color="#FF0000">*</font>        </td>
	</tr>
    <tr>
