<?php /* Smarty version 2.6.19, created on 2008-04-27 00:42:17
...
<form id="addtype" name="addtype" method="post" action="#">
    ...
    <tr>
        ...
        <td height="25" align="left" valign="middle" class="right">
        	<input name="names" type="text" id="names" class="txt" onMouseOver="this.style.backgroundColor='#ffffff'" onMouseOut="this.style.backgroundColor='#e8f4ff'">
      </td>
    </tr>
    <tr>
